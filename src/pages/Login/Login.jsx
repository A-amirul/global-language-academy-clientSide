		...
		<div className="hero min-h-screen bg-base-200">
			<div className="hero-content flex-col lg:flex-row-reverse">
				<div className="text-center lg:text-left w-1/2 mx-auto">
					...
					<p className="py-6">By registering at Global Language Academy, you will be able to shop and access the status and history of your enrollment. Create your new account easily.</p>
